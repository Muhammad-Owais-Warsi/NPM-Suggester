...
const Contact: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col md:flex-row items-center justify-center text-black">
            <motion.div
            ...
            >
                ...
                <form className="flex flex-col items-center md:items-start space-y-4">
                    ...
                    <button
                        type="submit"
                        className="px-6 py-3 bg-black text-white font-semibold rounded-md transition duration-300 transform hover:scale-105 hover:bg-gray-800"
                    >
                        Send Message
                    </button>
                </form>
