...
const HistorySection: React.FC<HistorySectionProps> = ({
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-xl dark:bg-gray-800  min-h-[270px] bg-white bg-opacity-60 backdrop-filter backdrop-blur-lg p-8 rounded-lg shadow-lg overflow-hidden"
    >
