...
import { RiGithubFill, RiMoonFill, RiSunFill } from "react-icons/ri"; // Import GitHub, Moon, and Sun icons from react-icons/ri
...
const NavBar: React.FC = () => {
    ...
    return (
        <nav className="bg-blue-600 dark:bg-gray-900 p-4 shadow-md flex items-center justify-between">
            {/* Animated H1 Tag */}
            <motion.h1
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className="text-white dark:text-gray-100 text-2xl font-bold"
            >
